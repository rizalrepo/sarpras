    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18"><i class="fas fa-chart-pie me-2"></i>Tambah Data Kategori SARPRAS</h4>
            ...
            <div class="card card-body border border-info">
                <form class="form-horizontal needs-validation" novalidate method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="ket_kategori" class="form-control" required></textarea>
                            <div class="invalid-feedback">Kolom tidak boleh kosong !</div>
                        </div>
                    </div>
...
if (isset($_POST['submit'])) {
    ...
    $tambah = $con->query("INSERT INTO kategori VALUES (
        default,
        '$nm_kategori',
        '$ket_kategori'
    )");

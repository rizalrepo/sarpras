    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18"><i class="fas fa-toolbox me-2"></i>Tambah Data Perbaikan Sarana dan Prasarana</h4>
            ...
            <div class="card card-body border border-info">
                <form class="form-horizontal needs-validation" novalidate method="POST" action="" enctype="multipart/form-data">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" name="tgl_baik" required>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="hidden" name="id_rusak" id="id_rusak" required>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="diperbaiki" required>
                            <div class="invalid-feedback">Kolom tidak boleh kosong !</div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control rupiah" name="biaya" required>
                            <div class="invalid-feedback">Kolom tidak boleh kosong !</div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="file" accept="image/*" class="form-control" name="foto_baik" required>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="ket_baik" required></textarea>
                            <div class="invalid-feedback">Kolom tidak boleh kosong !</div>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-hover table-striped dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = $con->query("SELECT * FROM rusak r LEFT JOIN sarpras a ON r.id_sarpras = a.id_sarpras LEFT JOIN kategori b ON a.id_kategori = b.id_kategori LEFT JOIN lokasi c ON a.id_lokasi = c.id_lokasi WHERE a.kondisi = 'Rusak' ORDER BY r.id_rusak DESC");
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['foto_baik']['name'])) {
        ...
        $foto_baik = $_POST['foto_baik'];
        $f_foto_baik .= "Upload Success!";
    }

    if (!empty($f_foto_baik)) {
        $tambah = $con->query("INSERT INTO baik VALUES (
            default, 
            '$tgl_baik', 
            '$id_rusak', 
            '$diperbaiki', 
        ...
        if ($tambah) {
            ...
            $data = $con->query("SELECT * FROM rusak WHERE id_rusak = '$id_rusak'")->fetch_array();

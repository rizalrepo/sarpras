    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18"><i class="fas fa-house-fire me-2"></i>Tambah Data Pemusnahan Sarana dan Prasarana</h4>
            ...
            <div class="card card-body border border-info">
                <form class="form-horizontal needs-validation" novalidate method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control bg-light" id="kondisi_lama" name="kondisi_lama" readonly required>
                            <div class="invalid-feedback">Kolom tidak boleh kosong !</div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="ket_musnah" required></textarea>
                            <div class="invalid-feedback">Kolom tidak boleh kosong !</div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="custom-width-modalLabel"><i class="fas fa-building-circle-check me-2"></i>Data Sarpras</h5>

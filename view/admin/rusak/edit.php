...
$id = $_GET['id'];
$query = $con->query("SELECT * FROM rusak r LEFT JOIN sarpras a ON r.id_sarpras = a.id_sarpras LEFT JOIN kategori b ON a.id_kategori = b.id_kategori LEFT JOIN lokasi c ON a.id_lokasi = c.id_lokasi WHERE r.id_rusak = '$id'");
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18"><i class="fas burst me-2"></i>Edit Data Kerusakan Sarana dan Prasarana</h4>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-hover table-striped dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $data = $con->query("SELECT * FROM sarpras a LEFT JOIN kategori b ON a.id_kategori = b.id_kategori LEFT JOIN lokasi c ON a.id_lokasi = c.id_lokasi WHERE a.kondisi = 'Baik' OR a.id_sarpras = '$row[id_sarpras]' ORDER BY a.id_sarpras DESC");
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($f_foto_rusak)) {
        ...
        if ($update) {
            ...
            $con->query("UPDATE sarpras SET kondisi = 'Baik' WHERE id_sarpras = '$invOld' ");

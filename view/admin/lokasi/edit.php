...
$id = $_GET['id'];
$query = $con->query(" SELECT * FROM lokasi WHERE id_lokasi ='$id'");
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18"><i class="fas fa-location-dot me-2"></i>Edit Data Lokasi</h4>
            ...
            <div class="card card-body border border-info">
                <form class="form-horizontal needs-validation" novalidate method="POST" action="" enctype="multipart/form-data">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nm_lokasi" value="<?= $row['nm_lokasi'] ?>" required>
...
if (isset($_POST['submit'])) {
    ...
    $update = $con->query("UPDATE lokasi SET 
        nm_lokasi = '$nm_lokasi'
        WHERE id_lokasi = '$id'
    ");
